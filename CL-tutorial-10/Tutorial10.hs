...
ddeltaNFA (NFA  qs as ts es ss fs ) source sym = eClose es (transition ts source sym)
...
-- Q10abc
-- (tidyFSM . minimalDFA . regex2nfa) undefined
-- (tidyFSM . minimalDFA . regex2nfa) undefined
-- (tidyFSM . minimalDFA . regex2nfa) undefined
...
-- (minimalDFA. regex2nfa) (foldr undefined undefined $ map S $ words sentence)
